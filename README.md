<img src="https://raw.githubusercontent.com/cai-ro-coders/Inventory-Management-System-Using-PHP-MySQL-PDO-and-MVC-architecture---Complete-Project/refs/heads/main/inventory_management_system_using_php_mysql_pdo_MVC_1.png" alt="Cairocoders Ednalan">
<img src="https://raw.githubusercontent.com/cai-ro-coders/Inventory-Management-System-Using-PHP-MySQL-PDO-and-MVC-architecture---Complete-Project/refs/heads/main/inventory_management_system_using_php_mysql_pdo_MVC_02.png" alt="Cairocoders Ednalan">
<img src="https://raw.githubusercontent.com/cai-ro-coders/Inventory-Management-System-Using-PHP-MySQL-PDO-and-MVC-architecture---Complete-Project/refs/heads/main/inventory_management_system_using_php_mysql_pdo_MVC_03.png" alt="Cairocoders Ednalan">

Build a Complete Admin Inventory Management System
...
stock_adjustment_items
    id (PK)
    stock_adjustment_id (FK → stock_adjustments.id)
    product_id (FK → products.id)
    old_quantity
    new_quantity
    difference
...
View all Products (paginated, searchable, Advanced Filters, Sorting)
...
Features:
View all Brand (paginated, searchable)
Create new Brand
Edit Brand details
Delete Brand
...
Features:
View all Unit (paginated, searchable)
Create new Unit
Edit Unit details
Delete Unit
...
Features:
View all Supplier (paginated, searchable)
Create new Supplier
